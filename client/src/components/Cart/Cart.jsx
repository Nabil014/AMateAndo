...
const Cart = ({ visible, onClose }) => {
  ...
  const refreshQty2 = (title, num) => {
    ...
    if (product.quantity === 0 && num === -1) return alert("La cantidad es 0!");
  ...
  return (
    ...
    >
      <div className="bg-white w-[90vw] p-2 rounded xl:w-[75vw] xl:h-[70vh] md:w-[85vw] lg:w-[85vw] relative h-[50vh] overflow-y-auto">
        <button
          onClick={onClose}
